...
submit.addEventListener("click", function (event) {
	...
	createUserWithEmailAndPassword(auth, email, password)
		.then((userCredential) => {
			...
			const uid = user.uid; // This is the UID of the newly created user

			// Redirect or perform any other actions based on the UID
			window.location.href = "dashboardEdit.html?uid=" + uid;
		})
		.catch((error) => {
